...
export function BottomTimeline({
  ...
  return (
    ...
    >
      ...
      {/* Timestamp display in bottom left corner */}
      <button
        onClick={handleTimestampClick}
        className="absolute bottom-2 left-2 rounded bg-ink-900/70 px-2 py-1 font-mono text-xs text-slate-300 transition-colors hover:bg-ink-800 hover:text-slate-100 cursor-pointer"
      ...
      >
        ...
        {copied && <span className="ml-2 text-green-400 text-[10px]">✓</span>}
      </button>
    </div>
  );
}
