...
export const UI = {
  en: {
    ...
    ogImageAlt: "The Cascade editor with an osu!mania beatmap open",
    legacy: LEGACY_EN,
  },
  de: {
    more: "Mehr",
    ...
    ogImageAlt: "Der Cascade-Editor mit einer geöffneten osu!mania-Beatmap",
    legacy: [],
  },
  ru: {
    more: "Ещё",
    ...
    ogImageAlt: "Редактор Cascade с открытой картой osu!mania",
    legacy: [],
  },
  "zh-CN": {
    more: "更多",
    ...
    languages: "其他语言",
    ogImageAlt: "打开了 osu!mania 谱面的 Cascade 编辑器",
    legacy: [],
  },
  "pt-BR": {
    more: "Mais",
    ...
    languages: "Leia em",
    ogImageAlt: "O editor Cascade com um beatmap de osu!mania aberto",
    legacy: [],
  },
};
